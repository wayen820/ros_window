  ...
  public partial class DrawArea : UserControl
  {
    ...
    public Point BackTrackMouse(Point p)
    {
      ...
      return pts[0];
        ...
        /// <param name="p"></param>
        /// <returns></returns>
    public PointF World2Map(Point p)
        {
            return new PointF(-p.Y * MapResolution, -p.X * MapResolution);
        }
        /// <summary>
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        public Point Map2World(PointF p)
        {
            return new Point((int)(-p.Y / MapResolution), (int)(-p.X / MapResolution));
        }
        /// <summary>
        /// 最近数据更新时间
        /// </summary>
    ...
    public void Initialize(MainForm owner, DocManager docManager)
    {
      ...
      tools[(int)DrawToolType.Connector] = new ToolConnector();
            tools[(int)DrawToolType.SetGoal] = new ROS.ToolGoal();
