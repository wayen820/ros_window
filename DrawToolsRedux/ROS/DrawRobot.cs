...
namespace DrawTools.ROS
{
    ...
    /// </summary>
    public class DrawRobot: DrawLine
    {
        ...
        DrawArea owner;
        public DrawRobot(DrawArea owner)
        {
        ...
        public DrawRobot(int x1, int y1, int x2, int y2, DrawArea owner)
        {
            pointArray = new ArrayList();
        ...
        public DrawRobot(int x1, int y1, int x2, int y2, DrawingPens.PenType p, DrawArea owner)
        {
            pointArray = new ArrayList();
            pointArray.Add(new Point(x1, y1));
            pointArray.Add(new Point(x2, y2));
        ...
        public DrawRobot(int x1, int y1, int x2, int y2, Color lineColor, int lineWidth, DrawArea owner)
        {
            pointArray = new ArrayList();
            pointArray.Add(new Point(x1, y1));
            pointArray.Add(new Point(x2, y2));
        ...
        private Subscriber<gm.PolygonStamped> footSub;
        //Thread fpThread;
        //bool isClosing;
        Transformer tfer;
        /// <summary>
